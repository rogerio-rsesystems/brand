...
|------|---|----------|--------|
| Jun 2026 | Q1 | **Colors: Navy + Gold on white** | Primary `#1B2A4A`, Accent `#C8A84B`, BG `#FFFFFF` |
| Jun 2026 | Q2 | **Fonts: Montserrat 800 (headings) + Inter 400/500/600 (body)** | Playfair Display rejected as "too 80s". Selected from 4-option visual comparison. |
| Jun 2026 | Q3 | **Testimonials: realistic placeholders** until real client quotes obtained | Remove fake "Jane Doe" immediately |
...
| Jun 2026 | Q10 | **Client portal: rebuild in-house** | Keep Firebase Auth + Firestore foundation. Full rebuild in Phase 5. |

---

## All Questions Resolved ✅
No open questions remaining. Phase 1 build can begin immediately.

---

## WhatsApp Roadmap Note
Rogerio wants to expand WhatsApp Business features in a future phase:
- Automated responses / greeting message
- Lead qualification bot
- Appointment booking via WhatsApp
- Multi-language support (EN/PT/ES)
Flag this for Phase 2 or post-launch enhancement.
